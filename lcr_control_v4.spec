...
# lcr_control_v4.spec - SynAptIp Nyquist Analyzer V4
...
for path in [str(src_v3_5_root), str(src_v3_root), str(src_v3_6_root), str(src_v4_root)]:
...
exe = EXE(
    ...
    a.datas,
    [],
    name="SynAptIp_Nyquist_Analyzer_V4",
    debug=False,
