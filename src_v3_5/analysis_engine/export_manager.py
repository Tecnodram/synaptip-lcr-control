...
def save_metadata(
    ...
    *,
    ...
    warnings_detected: Optional[list[str]] = None,
    normalization_applied: bool = True,
    dc_bias_grouping_used: bool = False,
) -> None:
    ...
    metadata_data: dict[str, Any] = {
        ...
        "dc_bias_grouping_used": dc_bias_grouping_used,
        "detected_schema": schema_info or {},
        "cleaning_summary": cleaning_summary or {},
        "plots_generated": plots_generated or [],
        "warnings_detected": warnings_detected or [],
    }
    _save_json(paths, "metadata_json",
               paths.metadata_dir / "metadata.json",
               metadata_data)
