"""
lcr_control_v4.py - SynAptIp Nyquist Analyzer V4 Entry Point
SynAptIp Technologies

V4 is based on the stable V3.6 branch and integrates logarithmic sweep
design directly into the main run workflow.
"""
...
_V4_DIR = (_BUNDLE_DIR / "src_v4") if getattr(sys, "frozen", False) else _HERE
...
def _startup_log_path() -> Path:
    return _BASE_DIR / "startup_v4.log"
...
sys.path[0:0] = [str(_V4_DIR), str(_V3_6_DIR), str(_V3_DIR), str(_V3_5_DIR)]
...
APP_NAME = "SynAptIp Nyquist Analyzer V4"
APP_VERSION = "4.0.0"
APP_ORG = "SynAptIp"
